...
class Farm_info(models.Model):
    ...
    farm_space = models.IntegerField(default=0,blank=True, null=True)
...
class Fertilizer(models.Model):
    ...
    farm_id = models.ForeignKey(Farm_info, on_delete=models.CASCADE)
    planting_id = models.ForeignKey(Planting, on_delete=models.CASCADE)
    fertilizer_name = models.CharField(max_length=50,blank=True, null=True)
...
class Pesticide_dose(models.Model):
    ...
    farm_id = models.ForeignKey(Farm_info, on_delete=models.CASCADE)
    planting_id = models.ForeignKey(Planting, on_delete=models.CASCADE)
    dose_name = models.CharField(max_length=50,blank=True, null=True)
...
class Pesticide(models.Model):
    ...
    farm_id = models.ForeignKey(Farm_info, on_delete=models.CASCADE)
    planting_id = models.ForeignKey(Planting, on_delete=models.CASCADE)
    pesticide_name = models.CharField(max_length=50,blank=True, null=True)
    dose_id = models.ForeignKey(Pesticide_dose, on_delete=models.CASCADE)
    purchased_from = models.BooleanField(default=True,blank=True, null=True)
