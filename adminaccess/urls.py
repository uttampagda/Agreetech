...
urlpatterns = [
    ...
    path('default_plant_name_reg', views.default_plant_name_reg, name="default_plant_name_reg"),
    path('add_default_plant_seed_name', views.add_default_plant_seed_name, name="add_default_plant_seed_name"),
